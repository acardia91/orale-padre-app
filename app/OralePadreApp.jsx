...
var dbModule = { loadAllData: loadAllData, savePromotions: savePromotions, saveStockAlerts: saveStockAlerts, saveIncidents: saveIncidents, saveIdeas: saveIdeas, saveIngredients: saveIngredients, saveProducts: saveProducts, saveMktData: saveMktData, saveCombos: saveCombos, saveClockRecords: saveClockRecords, saveChecklistRecords: saveChecklistRecords };
    ...
    <div style={{ fontFamily: "'Outfit', system-ui, sans-serif", background: "#f6f4f0", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      {role === "community" ? (
        <div style={{ background: "#1a1a1a", padding: "0 12px", borderBottom: "1px solid #E11D4830" }}>
          <div className="op-flat-nav">
            {nav.map(function(n) {
              ...
              var nk = n.k;
              return (
                <button key={nk} onClick={function() { pg[1](nk); }} style={{ display: "flex", alignItems: "center", gap: 5, padding: "10px 16px", borderRadius: 8, border: "none", cursor: "pointer", fontFamily: "inherit", background: active ? "#E11D48" : "transparent", color: active ? "#fff" : "#888", fontWeight: active ? 700 : 500, fontSize: 13, whiteSpace: "nowrap", flexShrink: 0, transition: "all 0.2s" }}>
                  {n.l}
                </button>
              );
            })}
        ...
        <div style={{ background: "#1a1a1a", borderBottom: "1px solid #B4530930" }}>
          {/* Row 1: Areas */}
          <div className="op-sub-row" style={{ display: "flex", gap: 0, padding: "0 12px", borderBottom: "1px solid #222" }}>
      ...
      {/* Content */}
      <div style={{ padding: "24px 16px", maxWidth: 1400, margin: "0 auto", overflowX: "hidden" }}>
