...
import { loadAllData, savePromotions, saveStockAlerts, saveIncidents, saveIdeas, saveIngredients, saveProducts, saveMktData, saveCombos, saveClockRecords, saveChecklistRecords, saveAlbaranes } from "./lib/db";

var dbModule = { loadAllData, savePromotions, saveStockAlerts, saveIncidents, saveIdeas, saveIngredients, saveProducts, saveMktData, saveCombos, saveClockRecords, saveChecklistRecords, saveAlbaranes };
...
export default function App() {
  ...
  var allNav = [
    ...
    { k: "rrhh-dorados", l: "Ingredientes Dorados", roles: ["socio"], group: "rrhh" },
        ...
        {!isMobile[0] && (
          <div className="op-sidebar">
            ...
            {sidebarGroups.map(function(g) {
              return (
                <div key={g.area.k}>
                  <div className="op-sidebar-group-label">{g.area.icon} {g.area.l}</div>
                  {g.items.map(function(item) {
                    ...
                    return (
                      <button key={ik} className={"op-sidebar-item" + (isActive ? " op-sidebar-item-active" : "")} onClick={function() { navigateTo(ik); }}>
                        <span>{item.l}</span>
    ...
    <div>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12, marginBottom: 20 }}>
        <div>
          ...
          <div style={{ fontSize: 13, color: "#888" }}>Gestion de personal e Ingredientes Dorados</div>
        </div>
        <div style={{ display: "flex", gap: 6 }}>
          {[{k:"equipo",l:"👥 Equipo"},{k:"dorados",l:"🌟 Ingredientes Dorados"},{k:"fichajes",l:"⏱️ Fichajes"},{k:"recompensas",l:"🎁 Recompensas"},{k:"config",l:"⚙️ Config"}].map(function(t) {
      ...
      {tab[0] === "equipo" && (
        <div>
                ...
                <div key={p.userId} style={{ ...crd, borderTop: "4px solid " + rc }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
                    ...
                    <div style={{ textAlign: "center" }}>
                      ...
                      <div style={{ fontSize: 9, color: "#B45309", fontWeight: 600 }}>🌟 DORADOS</div>
                    </div>
                  </div>
          ...
          <div style={{ marginTop: 20 }}>
            {!showAddPts[0] ? (
              <button onClick={function() { showAddPts[1](true); }} style={{ padding: "10px 18px", borderRadius: 10, border: "2px dashed #B45309", background: "#FFF7ED", color: "#B45309", fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}>+ Dar Ingredientes Dorados manualmente</button>
            ) : (
              <div style={{ ...crd, borderLeft: "4px solid #B45309" }}>
                <div style={{ fontSize: 13, fontWeight: 700, color: "#B45309", marginBottom: 12 }}>DAR INGREDIENTES DORADOS</div>
      ...
      {tab[0] === "dorados" && (
        <div>
          ...
          {/* How to earn */}
          <div style={{ ...crd }}>
            <div style={{ fontSize: 14, fontWeight: 700, marginBottom: 12 }}>Como ganar Ingredientes Dorados 🌟</div>
      ...
      {tab[0] === "recompensas" && (
        <div>
          <div style={{ fontSize: 13, color: "#888", marginBottom: 16 }}>Recompensas canjeables con Ingredientes Dorados. Gestiona el catalogo.</div>
      ...
      {tab[0] === "config" && (
        <div style={{ ...crd }}>
          ...
          <div style={{ marginTop: 16, padding: "12px 16px", background: "#FFF7ED", borderRadius: 10, fontSize: 12, color: "#92400E" }}>
            <strong>Como funciona:</strong> Los empleados y encargados ganan Ingredientes Dorados automaticamente al usar la plataforma: leer comunicados, reportar stock, crear incidencias, completar tareas. Al final de mes pueden canjear sus dorados por recompensas del catalogo.
          </div>
        </div>
      )}
    ...
    <div>
      ...
      <div style={{ background: "linear-gradient(135deg, #B45309 0%, #92400E 100%)", borderRadius: 14, padding: "24px", color: "#fff", marginBottom: 24, display: "flex", alignItems: "center", gap: 20, flexWrap: "wrap" }}>
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ fontSize: 12, opacity: 0.8 }}>Ingredientes Dorados</div>
        </div>
