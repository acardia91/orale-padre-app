...
import { loadAllData, savePromotions, saveStockAlerts, saveIncidents, saveIdeas, saveIngredients, saveProducts, saveMktData, saveCombos, saveClockRecords, saveChecklistRecords, saveAlbaranes, saveStockData, saveGamification, saveWeekTasks, savePriceHistory, savePrepSteps, saveStockMins, saveCateringLeads, saveCateringPresupuestos, createProduct } from "./lib/db";

var dbModule = { loadAllData, savePromotions, saveStockAlerts, saveIncidents, saveIdeas, saveIngredients, saveProducts, saveMktData, saveCombos, saveClockRecords, saveChecklistRecords, saveAlbaranes, saveStockData, saveGamification, saveWeekTasks, savePriceHistory, savePrepSteps, saveStockMins, saveCateringLeads, saveCateringPresupuestos, createProduct };
...
export default function App() {
  ...
  }, [promosData[0], stockAlerts[0], incidents[0], ideasState[0], savedCombos[0], clockRecords[0], checklistRecords[0], albaranesData[0], stockData[0], gamification[0], weekTasks[0], stockMins[0], cateringLeads[0], cateringPresupuestos[0]]);
