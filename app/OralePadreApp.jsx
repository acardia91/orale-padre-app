...
import { loadAllData, savePromotions, saveStockAlerts, saveIncidents, saveIdeas, saveIngredients, saveProducts, saveMktData } from './lib/db';
...
export default function App() {
  ...
  // Auto-save to Supabase when key state changes (debounced 3s)
  useEffect(function() {
    if (!dbLoaded[0]) return;
    if (saveTimer[0]) clearTimeout(saveTimer[0]);
    var t = setTimeout(function() {
      savePromotions(promosData[0]);
      saveStockAlerts(stockAlerts[0]);
      saveIncidents(incidents[0]);
      saveIdeas(ideasState[0]);
      saveIngredients(ing[0]);
      saveProducts(prod[0]);
      saveMktData(mktData[0]);
    }, 3000);
    saveTimer[1](t);
